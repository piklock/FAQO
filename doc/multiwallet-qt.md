...
In order to support loading of multiple wallets in faqo-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is faqo.cpp.
...
Changes to faqo.cpp
----------------------
faqo.cpp is the entry point into faqo-qt, and as such, will require some minor modifications to provide hooks for
