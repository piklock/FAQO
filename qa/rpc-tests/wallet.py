...
#   c) node1 mines 32 blocks, so now node 0 has 60001FFQ, node 1 has 4250FFQ, node2 has none.
#   d) node0 sends 601 FFQ to node2, in two transactions (301 FFQ, then 300 FFQ).
