...
/* FAQO GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "FAQO"
#define QAPP_ORG_DOMAIN "faqo.org"
#define QAPP_APP_NAME_DEFAULT "FAQO-Qt"
#define QAPP_APP_NAME_TESTNET "FAQO-Qt-testnet"
