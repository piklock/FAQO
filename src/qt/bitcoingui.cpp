                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("FAQO Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a FAQO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and faqo: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zFFQ"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About FAQO Core"), this);
    aboutAction->setStatusTip(tr("Show information about FAQO Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for FAQO"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your FAQO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified FAQO addresses"));
    ...
    openAction->setStatusTip(tr("Open a FAQO: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the FAQO Core help message to get a list with possible FAQO command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("FAQO Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FAQO network", "", count));
}
...
{
    QString strTitle = tr("FAQO Core"); // default title
