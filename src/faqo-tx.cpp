...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("FAQO Core faqo-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  faqo-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded faqo transaction") + "\n" +
                               "  faqo-tx [options] -create [commands]   " + _("Create hex-encoded faqo transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded faqo transaction
