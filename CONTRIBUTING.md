Contributing to FAQO Core
============================

The FAQO Core project operates an open contributor model where anyone is
...
The following applies to code changes to the FAQO Core project, and is not to be
confused with overall FAQO Network Protocol consensus changes.

Whether a pull request is merged into FAQO Core rests with the project merge
...
Patches that change FAQO consensus rules are considerably more involved than
...
Where a patch set proposes to change the FAQO consensus, it must have been
...
The project leader is the release manager for each FAQO Core release.
